<template>
  <div class="scene-editor">
    ...
    <div class="main-box step-one-box" ref="stepItem1">
      ...
      <img  class="cosmos-video" :class="{'right-video': showVideo}" style="border-radius: 24px;" src="../assets/images/cptx-img1.png" alt="智能孪生">
    </div>
    <div class="main-box step-one-box">
      ...
      <img  class="cosmos-video" :class="[{'right-video': showVideo}, 'left-video']" style="border-radius: 24px;" src="../assets/images/cptx-img2.png" alt="智能孪生">
    </div>
    <div class="main-box step-one-box">
      <div class="text-box">
      ...
      <img  class="cosmos-video" :class="{'right-video': showVideo}" style="border-radius: 24px;" src="../assets/images/cptx-img3.png" alt="智能孪生">
    </div>
    <div class="main-box step-one-box">
      <div class="text-box right-text-box">
      ...
      <img  class="cosmos-video" :class="[{'right-video': showVideo}, 'left-video']" style="border-radius: 24px;" src="../assets/images/cptx-img4.png" alt="智能孪生">
    </div>
