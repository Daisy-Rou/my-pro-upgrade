  ...
  <div class="smart-city">
    ...
    <div class="step-two-bg-box">
      ...
      <div class="card-box">
        <div class="card-item">
          <div class="img-box">
            <img src="../assets/images/zhcs-cpys1.png" alt="">
          </div>
        ...
        <div class="card-item">
          <div class="img-box">
            <img src="../assets/images/zhcs-cpys2.png" alt="">
          </div>
          <div class="card-item-title-box">
        ...
        <div class="card-item">
          <div class="img-box">
            <img src="../assets/images/zhcs-cpys3.png" alt="">
          </div>
          <div class="card-item-title-box">
        ...
        <div class="card-item">
          <div class="img-box">
            <img src="../assets/images/zhcs-cpys4.png" alt="">
          </div>
          <div class="card-item-title-box">
...
.smart-city {
  ...
  .szls-box {
    ...
    flex-direction: column;
    padding: 40px 128px;
    background-image: linear-gradient(to bottom, rgba(0, 0, 0, .35), #000), url(../assets/images/szls-bg.png);
    aspect-ratio: 1920 / 687;
    object-fit: cover;
    background-size: 100% 100%;
    &.szls-bg-znyw {
      background-image: linear-gradient(to bottom, rgba(0, 0, 0, .35), #000), url(../assets/images/znyw-bg.png);
    }
    &.szls-bg-jcpt {
      background-image: linear-gradient(to bottom, rgba(0, 0, 0, .35), #000), url(../assets/images/jcpt-bg.png);
    }
    .szls-item-box {
      display: flex;
      flex-direction: row;
