...
.smart-factory {
  ...
  .szls-box {
    ...
    &.szls-bg-znyw {
      background-image: linear-gradient(to bottom, rgba(0, 0, 0, .35), #000), url(../assets/images/zhgc-znyw.png);
    }
    &.szls-bg-jcpt {
      background-image: linear-gradient(to bottom, rgba(0, 0, 0, .35), #000), url(../assets/images/zhgc-jcpt.png);
    }
    .szls-item-box {
      display: flex;
      flex-direction: row;
